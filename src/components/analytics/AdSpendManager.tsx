    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading ad spend data...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-4">
              <h1 className="text-2xl font-bold text-gray-900">Ad Spend Management</h1>
          ...
          <div className="px-4 py-5 sm:p-6">
            ...
            {adSpendData.length === 0 ? (
              <div className="text-center py-12">
                ...
                <h3 className="mt-2 text-sm font-medium text-gray-900">No ad spend data</h3>
                <p className="mt-1 text-sm text-gray-500">Get started by adding your first ad spend record.</p>
                <div className="mt-6">
                  <button
                    onClick={() => setShowForm(true)}
                    ...
                    {adSpendData.map((ad) => (
                      <tr key={ad.id} className="hover:bg-gray-50">
                        <td className="px-6 py-4 whitespace-nowrap">
                          ...
                          {ad.meta_campaign_id && (
                            <div className="text-sm text-gray-500">ID: {ad.meta_campaign_id}</div>
                          )}
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
