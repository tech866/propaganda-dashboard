-- =====================================================
-- Update Calls Schema for SCRM Requirements - FIXED VERSION
...
-- =====================================================
-- 3. FIX EXISTING DATA ISSUES FIRST
-- =====================================================

-- Fix any invalid loss_reason_id references by setting them to NULL
UPDATE calls 
SET loss_reason_id = NULL 
WHERE loss_reason_id IS NOT NULL 
AND loss_reason_id NOT IN (SELECT id FROM loss_reasons);
