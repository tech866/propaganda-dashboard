...
-- Propaganda Dashboard - Drop All Tables and Start Fresh
...
DROP TABLE IF EXISTS sales_metrics_config CASCADE;
DROP TABLE IF EXISTS sales_metrics_snapshots CASCADE;
DROP TABLE IF EXISTS template_financial CASCADE;
DROP TABLE IF EXISTS template_metrics CASCADE;
DROP TABLE IF EXISTS traffic_source_attributions CASCADE;
...
DROP VIEW IF EXISTS metrics_by_traffic_source CASCADE;

-- Drop any functions that might exist
DROP FUNCTION IF EXISTS calculate_close_rate CASCADE;
DROP FUNCTION IF EXISTS calculate_show_rate CASCADE;
DROP FUNCTION IF EXISTS calculate_aov CASCADE;
DROP FUNCTION IF EXISTS sync_clerk_user CASCADE;
DROP FUNCTION IF EXISTS update_updated_at_column CASCADE;
DROP FUNCTION IF EXISTS create_workspace CASCADE;
DROP FUNCTION IF EXISTS invite_user_to_workspace CASCADE;
DROP FUNCTION IF EXISTS accept_workspace_invitation CASCADE;
...
-- Create users table - CRITICAL for Clerk sync
CREATE TABLE users (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
...
-- Create calls table - ENHANCED with all your actual fields
CREATE TABLE calls (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    client_id UUID REFERENCES clients(id) ON DELETE CASCADE,
...
-- Create enhanced_call_analytics view
...
-- =====================================================
-- 6. CREATE METRICS CALCULATION FUNCTIONS
-- =====================================================
...
-- ✅ Created fresh core tables: users, clients, calls, loss_reasons
-- ✅ Added all enhanced call fields matching your code
-- ✅ Set up Clerk user sync functionality
-- ✅ Created metrics calculation functions (close rate, show rate, AOV)
-- ✅ Created analytics views for your dashboard
-- ✅ Set up RLS policies for security
-- ✅ Added performance indexes
-- ✅ Added default loss reasons data
-- 
-- Your database is now completely fresh and ready for production! 🎯
